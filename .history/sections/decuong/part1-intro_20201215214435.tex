...
\begin{itemize}
    \item Thực hiện khảo sát những phương pháp nổi bật trong lĩnh vực nghiên cứu, từ thời điểm hiện tại trở về trước. Nghiên
          cứu ưu nhược điểm của từng phương pháp cũng như tiến hành hiện thực lại để nghiệm thu và đánh giá kết quả.
    \item Từ kết quả khảo sát chung, tiến hành chọn ra phương pháp khả thi nhất làm phương pháp nền tảng để đi sâu nghiên cứu.
    \item Tìm ra những vấn đề tồn đọng của phương pháp đã chọn, nghiên cứu cải tiến để được mục đích mong muốn.
    \item Thử hiện thực phương pháp để có kết quả bước đầu, nhằm đảm bảo tính khả thi của phương pháp, từ đó tạo tiền
          đề cho việc đi sâu phát triển ở giai đoạn về sau.
    \item Tìm ra các vấn
    \item
...
Để phù hợp với lượng thời gian  hạn chế của giai đoạn đề cương, nhóm tập trung nghiên cứu trong phạm vi:
\begin{itemize}
