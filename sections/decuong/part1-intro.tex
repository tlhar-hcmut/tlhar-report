...
Tuy nhiên, trên thực tế khả năng của AI đa phần chỉ mới tiệm cận khả năng thực sự của con người, thậm chí ở một số bài toán, AI vẫn đang ở giai đoạn
...
\begin{itemize}
      ...
      \item Chuẩn bị dữ liệu và các tài nguyên cần thiết cho phương pháp đã chọn, cũng như thử hiện thực phương pháp để có kết quả bước đầu,
...
\begin{itemize}
      ...
      % \item Chỉ mới thao tác trên các hành động phổ biến, gồm 64 hành động hay là 64 classes cho bài toán nhận diện hành vi qua video, về sau nhóm sẽ mở rộng
